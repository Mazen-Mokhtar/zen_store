...
const translations: Record<string, Translation> = {
  en: {
    ...
    coupon: {
      ...
      alreadyUsed: 'Coupon has already been used',
      minOrderAmount: 'Minimum order amount not met',
      notApplicable: 'Coupon not applicable to this order',
      discount: 'Discount',
      ...
      fixed: 'Fixed Amount',
      validationError: 'Error validating coupon',
  ...
  ar: {
    ...
    coupon: {
      ...
      alreadyUsed: 'تم استخدام الكوبون من قبل',
      minOrderAmount: 'لم يتم الوصول للحد الأدنى لمبلغ الطلب',
      notApplicable: 'الكوبون غير قابل للتطبيق على هذا الطلب',
      discount: 'خصم',
      ...
      fixed: 'مبلغ ثابت',
      validationError: 'خطأ في التحقق من الكوبون',
